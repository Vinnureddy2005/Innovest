...
//   return (
//     <div className='min-h-screen bg-gradient-to-r from-cyan-100 to-[#f3d2b5] '>
//        <div >
//        <img src="/images/home-1.png"  className="absolute bottom-20 right-10 w-2/4 max-w-full h-auto object-contain opacity-90" />
//        </div>
...
//       <span>Innovest</span>
//     </div>  <ul className="flex gap-6 text-gray-700 mr-[30]">
