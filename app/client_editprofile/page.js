...
//       reader.onloadend = () => {
//         setSelectedPhotoBase64(reader.result); // Save new image
//         setPreviewPic(reader.result);          // Update preview
//       };
...
//             <div className="flex flex-col">
//               <label className="text-sm font-semibold text-gray-600 mb-2">Profile Photo</label>
//               <input
//                 type="file"
//                 accept="image/*"
