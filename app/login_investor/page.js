...
//     setError('');
//     try {
//       const res = await fetch('/api/login_investor', {
//         method: 'POST',
...
//               New User? <Link href="/signup_investor" className="text-purple-300 hover:underline">Signup</Link>
//             </p>
//           </form>
//         </div>
//       </div>
...
import LoginForm from '../components/Login_inv';
