...
//           <li>
//             <button  onClick={()=>handleScrollTo('home')} className="hover:text-gray-900">Home</button>
//           </li>
//           <li>
//             <button  onClick={()=>handleScrollTo('about')} className="hover:text-gray-900">About</button>
//           </li>
//           <li>
//           <button  onClick={()=>handleScrollTo('works')} className="hover:text-gray-900">Services</button>
//           </li>
//           <li>
//           <button  onClick={()=>handleScrollTo('contact')} className="hover:text-gray-900">Contact</button>
//           </li>
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-cyan-100 to-[#f3d2b5] overflow-x-hidden">
      {/* ✅ Replaced <img> with <Image /> and added alt */}
      <div>
        <Image 
          src="/images/home-1.png" 
          alt="Home image"
      ...
      <div className="absolute top-40 left-10 md:left-40 w-11/12 md:w-1/3 font-serif">
        ...
        <h3 className="text-xl absolute top-50 left-10">
