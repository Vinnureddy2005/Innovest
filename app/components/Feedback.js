...
//   return (
//     <div className="fixed inset-0 flex items-center justify-center bg-transparent backdrop-blur-sm z-50" aria-modal="true" role="dialog" aria-labelledby="feedback-title">
...
//         <h2 id="feedback-title" className="text-xl font-semibold text-indigo-600 mb-4 text-center">
//           Startup Idea Feedback
//         </h2>

//         <form onSubmit={handleSubmit} className="space-y-4">
//           <div>
//             <label htmlFor="clarity" className="block text-gray-700 mb-1">How clear is the startup idea?</label>
//             <select
//               id="clarity"
//               name="clarity"
//               required
...
//             >
//               <option value="" disabled>Select clarity level</option>
...
//           <div>
//             <label htmlFor="feasibility" className="block text-gray-700 mb-1">How feasible is this idea?</label>
//             <select
//               id="feasibility"
//               name="feasibility"
//               required
...
//           <div>
//             <label htmlFor="uniqueness" className="block text-gray-700 mb-1">How unique is the idea?</label>
//             <select
//               id="uniqueness"
//               name="uniqueness"
//               required
...
//               className="w-full px-3 py-2 border rounded-md"
//             >
//               <option value="" disabled>Select uniqueness</option>
...
//           <div>
//             <label htmlFor="improvementSuggestions" className="block text-gray-700 mb-1">Suggestions</label>
//             <textarea
...
//           <div>
//             <label htmlFor="overallRating" className="block text-gray-700 mb-1">Overall rating</label>
//             <select
//               id="overallRating"
//               name="overallRating"
//               required
...
const FeedbackPopup = ({startupId,startupName,clientEmail,Invphoto, onClose }) => {
  console.log("✅ FeedbackPopup component loaded");
const now = new Date();
