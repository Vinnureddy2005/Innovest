...
//           <h2 className="text-3xl font-bold text-white text-center mb-4">Welcome Back Innovator!</h2>
...
// app/login_client/page.js

'use client';

import LoginForm from '../components/Login_client';
